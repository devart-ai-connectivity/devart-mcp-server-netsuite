// --------------------------------------------------------------------------
// <copyright file="OdbcNetSuitePrimaryKeysTool.cs" company="Devart">
//
...
namespace Devart.AI.McpServer.Odbc.NetSuite.Tools
{
  internal sealed class OdbcNetSuitePrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
