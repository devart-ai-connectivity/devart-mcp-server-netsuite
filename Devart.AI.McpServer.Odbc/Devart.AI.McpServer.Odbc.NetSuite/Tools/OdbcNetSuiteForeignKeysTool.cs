// --------------------------------------------------------------------------
// <copyright file="OdbcNetSuiteForeignKeysTool.cs" company="Devart">
//
...
{
  internal sealed class OdbcNetSuiteForeignKeysTool(McpConfiguration serverConfiguration) : ForeignKeysTool(serverConfiguration)
  {
